...
(function($) {
   ...
   $.fn.quizbox = function(settings) {
	...
	$.fn.quizbox.start = function(el, o) {
		...
		doInit(); /* DELETES DATASTORE ENTRIES */
	...
	$.fn.quizbox.changeItem = function(n) {
		...
		if (url.match(/#/)) {
			...
			$.fn.quizbox.showItem('<iframe id="quiz_frame" onload="$.fn.quizbox.showIframe()" name="quiz_iframe' + Math.round(Math.random()*1000) + '" frameborder="0" hspace="0" src="' + url + '"></iframe>');
		}
	};
...
/* Fill in titles for answer keys */
	...
	$.fn.quizbox.init = function() {
		if (!$('#quiz_wrap').length) {
			...
			$('<a id="answer1" class="answer" href="javascript:;"><table cellspacing="0" cellpadding="0" border="0" ><tr> <td id="quiz_title_left"></td><td id="quiz_title_main"><div id="answer1"></div></td><td id="quiz_title_right"></td></tr></table></a>').appendTo('#quiz_title');
             $('<a id="answer2" class="answer"href="javascript:;"><table cellspacing="0" cellpadding="0" border="0" ><tr><td id="quiz_title_left"></td><td id="quiz_title_main"><div id="answer2"></div></td><td id="quiz_title_right"></td></tr></table></a>').appendTo('#quiz_title');
              $('<a id="answer3" class="answer"href="javascript:;"><table cellspacing="0" cellpadding="0" border="0" ><tr><td id="quiz_title_left"></td><td id="quiz_title_main"><div id="answer3"></div></td><td id="quiz_title_right"></td></tr></table></a>').appendTo('#quiz_title');
    ...
    function reset_minute(){
        ...
        //update_minute());
             ...
             /* submit answers and proceed to next question */
                ...
                $('#answer1').click(function(){ submit_answer('#answer1'); });
 ...
 function submit_answer(answer){
     ...
     /* submit using AJAX function */
     
     doAdd(answer_text, "correct answer")
